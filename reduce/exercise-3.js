...
const winningTeams = teams.reduce((curentTeam, team) => {
  if (team.isWinner) {
    curentTeam[team.name.toLowerCase()] = team.score;
  }
  return curentTeam;
}, {});
...
// remember to put the return AFTER the if statement.... or it will not work
// it will work without the toLowerCase() but you need it eventually
